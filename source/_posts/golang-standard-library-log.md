...
整个 log 包就 300 多行代码，功能非常简单，使用起来也很方便。对于标准库来说，考虑的更多的是简洁、通用，而对于后端服务来说，则需要考虑更多的东西，比如结构化日志、性能问题等。目前有很多优秀的开源日志库，例如：`zap`、`gokit/log`、`logrus` 等，各有各的优势，所以在日志库选型上我们可以更加的灵活一点。在吸取了一些设计精髓的基础上，自己也可以造个轮子来解决问题。